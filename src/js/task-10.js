...
class Hero{
  constructor(id){
		this.id = id;
		this.image = '../images/jun_dev.jpeg';
		this.info = this.getInfo();
	}

  async getInfo(){
		let request = await fetch('./json/jundev.json'),
  ...
  renderInfo(){
	...
	renderImage(){
		return `<img src="./images/${this.image}" alt="${this.name}" width="200" height="200">`;
	}

}

export let JunDev = new Hero('task-10');