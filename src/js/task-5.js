...
class Hero {
    constructor(id) {
        this.id = id;
        this.image = '../images/rick.png';
        this.info = this.getInfo();
    }

    async getInfo() {
        let request = await fetch('./json/rick.json'),
    ...
    renderImage() {
        return `<img src="./images/${this.image}" alt="${this.name}" width="300" height="250">`;
    }

}

export let Rick = new Hero('task-5');